                            ...
                            <div class="box-body" style="border: solid 1px; padding: 10px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center" style="float: left;">
                                        ...
                                        <h6><strong>Chittagong, Bangladesh</strong></h6>
                                                ...
                                                @foreach ($allGrades as $mark)
                                                    <tr>
                                                        ...
                                                        <td>{{ number_format((float) $mark->grade_point, 2) }} -
                                                            {{ $mark->grade_point == 5 ? number_format((float) $mark->grade_point, 2) : number_format((float) $mark->grade_point + 1, 2) - (float) 0.01 }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
