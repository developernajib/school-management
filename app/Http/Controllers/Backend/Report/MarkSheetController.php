...
class MarkSheetController extends Controller
{
	public function MarkSheetView()
	{
		...
		return view('backend.admin.dashboard.report.marksheet.marksheet_view', $data);
	}
	...
	public function MarkSheetGet(Request $request)
	{
		...
		if ($singleStudent == true) {
			...
			return view('backend.admin.dashboard.report.marksheet.marksheet_pdf', compact('allMarks', 'allGrades', 'count_fail'));
		} else {
			$notification = array(
