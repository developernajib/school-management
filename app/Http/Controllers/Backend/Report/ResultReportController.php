...
class ResultReportController extends Controller
{
	public function ResultView()
	{
		...
		return view('backend.admin.dashboard.report.student_result.student_result_view', $data);
	}
	...
	public function ResultGet(Request $request)
	{
		...
		if ($singleResult == true) {
			...
			$pdf = PDF::loadView('backend.admin.dashboard.report.student_result.student_result_pdf', $data);
			$pdf->SetProtection(['copy', 'print'], '', 'pass');
			$pdfName = 'rr-id-' . $class_id;
	...
	public function IdcardView()
	{
		$data['years'] = StudentYear::all();
		$data['classes'] = StudentClass::all();
		return view('backend.admin.dashboard.report.idcard.idcard_view', $data);
	}
	...
	public function IdcardGet(Request $request)
	{
		...
		if ($check_data == true) {
			...
			$pdf = PDF::loadView('backend.admin.dashboard.report.idcard.idcard_pdf', $data);
			$pdf->SetProtection(['copy', 'print'], '', 'pass');
			$pdfName = 'rr-id-' . $class_id;
			return $pdf->stream($pdfName);
		} else {
