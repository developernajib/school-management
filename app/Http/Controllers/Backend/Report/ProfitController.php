...
class ProfitController extends Controller
{
	...
	{
		return view('backend.admin.dashboard.report.profit.profit_view');
	}
	...
	public function MonthlyProfitPdf(Request $request)
	{
		...
		$pdf = PDF::loadView('backend.admin.dashboard.report.profit.profit_pdf', $data);
		$pdf->SetProtection(['copy', 'print'], '', 'pass');
		$pdfName = 'profit-sdate-' . $request->start_date;
