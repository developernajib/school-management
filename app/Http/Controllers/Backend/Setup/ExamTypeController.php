...
class ExamTypeController extends Controller
{
	public function ViewExamType()
	{
		...
		return view('backend.admin.dashboard.setup.exam_type.view_exam_type', $data);
	}

	public function ExamTypeAdd()
	{
		return view('backend.admin.dashboard.setup.exam_type.add_exam_type');
	}
	...
	public function ExamTypeEdit($id)
	{
		...
		return view('backend.admin.dashboard.setup.exam_type.edit_exam_type', compact('editData'));
	}
