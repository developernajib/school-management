...
class FeeCategoryController extends Controller
{
	public function ViewFeeCat()
	{
		...
		return view('backend.admin.dashboard.setup.fee_category.view_fee_cat', $data);
	}

	public function FeeCatAdd()
	{
		return view('backend.admin.dashboard.setup.fee_category.add_fee_cat');
	}
	...
	public function FeeCatEdit($id)
	{
		...
		return view('backend.admin.dashboard.setup.fee_category.edit_fee_cat', compact('editData'));
	}
