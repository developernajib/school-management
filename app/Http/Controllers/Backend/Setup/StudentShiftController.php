...
class StudentShiftController extends Controller
{
	public function ViewShift()
	{
		...
		return view('backend.admin.dashboard.setup.shift.view_shift', $data);
	}

	public function StudentShiftAdd()
	{
		return view('backend.admin.dashboard.setup.shift.add_shift');
	}
	...
	public function StudentShiftEdit($id)
	{
		...
		return view('backend.admin.dashboard.setup.shift.edit_shift', compact('editData'));
	}
