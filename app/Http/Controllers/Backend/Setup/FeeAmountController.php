...
class FeeAmountController extends Controller
{
	public function ViewFeeAmount()
	{
		...
		return view('backend.admin.dashboard.setup.fee_amount.view_fee_amount', $data);
	}
	...
	public function AddFeeAmount()
	{
		...
		return view('backend.admin.dashboard.setup.fee_amount.add_fee_amount', $data);
	}
	...
	public function EditFeeAmount($fee_category_id)
	{
		...
		$data['fee_categories'] = FeeCategory::all();
		$data['classes'] = StudentClass::all();
		return view('backend.admin.dashboard.setup.fee_amount.edit_fee_amount', $data);
	}
	...
	public function DetailsFeeAmount($fee_category_id)
	{
		...
		return view('backend.admin.dashboard.setup.fee_amount.details_fee_amount', $data);
	}
}
