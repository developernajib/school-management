...
class RegistrationFeeController extends Controller
{
	public function RegFeeView()
	{
		...
		return view('backend.admin.dashboard.student.registration_fee.registration_fee_view', $data);
	}
	...
	public function RegFeePayslip(Request $request)
	{
		...
		$pdf = PDF::loadView('backend.admin.dashboard.student.registration_fee.registration_fee_pdf', $allStudent);
		$pdf->SetProtection(['copy', 'print'], '', 'pass');
		$pdfName = 'student-reg-id-' . $student_id;
