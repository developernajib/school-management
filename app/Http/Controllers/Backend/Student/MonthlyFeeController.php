...
class MonthlyFeeController extends Controller
{
	public function MonthlyFeeView()
	{
		...
		return view('backend.admin.dashboard.student.monthly_fee.monthly_fee_view', $data);
	}
	...
	public function MonthlyFeePayslip(Request $request)
	{
		...
		$pdf = PDF::loadView('backend.admin.dashboard.student.monthly_fee.monthly_fee_pdf', $data);
		$pdf->SetProtection(['copy', 'print'], '', 'pass');
		$pdfName = 'student-mfee-id-' . $student_id;
