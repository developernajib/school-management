...
class ExamFeeController extends Controller
{
	...
	public function ExamFeeView()
	{
		...
		return view('backend.admin.dashboard.student.exam_fee.exam_fee_view', $data);
	}
	...
	public function ExamFeePayslip(Request $request)
	{
		...
		$pdf = PDF::loadView('backend.admin.dashboard.student.exam_fee.exam_fee_pdf', $data);
		$pdf->SetProtection(['copy', 'print'], '', 'pass');
		$pdfName = 'student-efee-id- ' . $student_id;
