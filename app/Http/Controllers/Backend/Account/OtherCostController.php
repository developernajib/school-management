...
class OtherCostController extends Controller
{
	public function OtherCostView()
	{
		...
		return view('backend.admin.dashboard.account.other_cost.other_cost_view', $data);
	}

	public function OtherCostAdd()
	{
		return view('backend.admin.dashboard.account.other_cost.other_cost_add');
	}
	...
	public function OtherCostEdit($id)
	{
		...
		return view('backend.admin.dashboard.account.other_cost.other_cost_edit', $data);
	}
