...
class AccountSalaryController extends Controller
{
	public function AccountSalaryView()
	{
		...
		return view('backend.admin.dashboard.account.employee_salary.employee_salary_view', $data);
	}
	...
	public function AccountSalaryAdd()
	{
		...
		return view('backend.admin.dashboard.account.employee_salary.employee_salary_add');
	}
