...
class EmployeeSalaryController extends Controller
{
	public function SalaryView()
	{
		...
		return view('backend.admin.dashboard.employee.employee_salary.employee_salary_view', $data);
	}

	public function SalaryIncrement($id)
	{
		$data['editData'] = Moderator::find($id);
		return view('backend.admin.dashboard.employee.employee_salary.employee_salary_increment', $data);
	}
	...
	public function SalaryDetails($id)
	{
		...
		return view('backend.admin.dashboard.employee.employee_salary.employee_salary_details', $data);
	}
}
