...
class MonthlySalaryController extends Controller
{
	...
	{
		return view('backend.admin.dashboard.employee.monthly_salary.monthly_salary_view');
	}
	...
	public function MonthlySalaryPayslip(Request $request, $employee_id)
	{
		...
		$pdf = PDF::loadView('backend.admin.dashboard.employee.monthly_salary.monthly_salary_pdf', $data);
		$pdf->SetProtection(['copy', 'print'], '', 'pass');
		$pdfName = 'monthly-s-id- ' . $employee_id;
